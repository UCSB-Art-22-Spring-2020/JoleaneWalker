void swim() {
  ...
  if (FishZ4> 350 || FishZ4<-350) {
    ...
    //direction change for fish 5
  if (FishX5> 350 || FishX5<-350) {
    XDirection5=XDirection5*-1;
    swimSpeed=random(1, 5);
  }
  if (FishY5> 350 || FishY5<-250) {
    YDirection5=YDirection5*-1;
  }
  if (FishZ5> 350 || FishZ5<-350) {
    ZDirection5=ZDirection5*-1;
  }
}
